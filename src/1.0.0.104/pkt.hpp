...
enum pkttype_e
{
    ...
    PKT_C2S_OnQuestEvent = 0x90,
    PKT_S2C_HandleTipUpdate = 0x91,
    PKT_S2C_HandleUIHighlight = 0x92,
    PKT_C2S_OnTipEvent = 0x93,
    PKT_S2C_PlayVOAudioEvent = 0x94,
    PKT_ChangeSlotSpellType = 0x95,
    PKT_PausePacket = 0x96,
    PKT_ResumePacket = 0x97,
    PKT_SetFrequency = 0x98,
    PKT_SetFadeOut_Push = 0x99,
    PKT_SetFadeOut_Pop = 0x9A,
    PKT_S2C_CreateUnitHighlight = 0x9B,
    PKT_S2C_RemoveUnitHighlight = 0x9C,
    PKT_S2C_OpenTutorialPopup = 0x9D,
    PKT_C2S_OnTutorialPopupClosed = 0x9E,
    PKT_S2C_OpenAFKWarningMessage = 0x9F,
    PKT_S2C_CloseShop = 0xA0,
    PKT_S2C_SetInputLockingFlag = 0xA1,
    PKT_C2S_OnShopOpened = 0xA2,
    PKT_S2C_ShowObjectiveText = 0xA4,
    PKT_S2C_HideObjectiveText = 0xA5,
    PKT_S2C_RefreshObjectiveText = 0xA6,
    PKT_S2C_ShowAuxiliaryText = 0xA7,
    PKT_S2C_HideAuxiliaryText = 0xA8,
    PKT_S2C_RefreshAuxiliaryText = 0xA9,
    PKT_S2C_HighlightHUDElement = 0xAA,
    PKT_S2C_HighlightShopElement = 0xAB,
    PKT_C2S_TeamSurrenderVote = 0xAC,
    PKT_S2C_TeamSurrenderVote = 0xAD,
    PKT_S2C_TeamSurrenderCountDown = 0xAE,
    PKT_S2C_TeamSurrenderStatus = 0xAF,
    PKT_S2C_LineMissileHitList = 0xB0,
    PKT_C2S_TutorialAudioEventFinished = 0xB1,
    PKT_S2C_HighlightTitanBarElement = 0xB2,
    PKT_S2C_ToggleUIHighlight = 0xB3,
    PKT_S2C_DisplayLocalizedTutorialChatText = 0xB4,
    PKT_S2C_ToolTipVars = 0xB5,
    PKT_S2C_MuteVolumeCategory = 0xB6,
    PKT_S2C_OnEventWorld = 0xB7,
    PKT_S2C_AnimatedBuildingSetCurrentSkin = 0xB8,
    PKT_S2C_SetGreyscaleEnabledWhenDead = 0xB9,
    PKT_S2C_DisableHUDForEndOfGame = 0xBA,
    PKT_ChangeSlotSpellName = 0xBB,
    PKT_S2C_SwitchNexusesToOnIdleParticles = 0xBC,
    PKT_S2C_FadeMinions = 0xBD,
    PKT_S2C_FadeOutMainSFX = 0xBE,
    PKT_S2C_HeroStats = 0xBF,
    PKT_S2C_SetAnimStates = 0xC0,
    PKT_ClientCheatDetectionSignal = 0xC1,
    PKT_S2C_AddDebugCircle = 0xC2,
    PKT_S2C_RemoveDebugCircle = 0xC3,
    PKT_S2C_ModifyDebugCircleRadius = 0xC4,
    PKT_S2C_ModifyDebugCircleColor = 0xC5,
    PKT_Undefined = 0xC6,
    PKT_S2C_Neutral_Camp_Empty = 0xC7,
    PKT_Batched = 0xFF,
};
