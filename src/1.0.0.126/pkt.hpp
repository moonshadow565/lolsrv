...
enum pkttype_e
{
    ...
    PKT_SPM_HierarchicalBBProfileUpdate = 0xBE,
    ...
    PKT_Undefined = 0xCF,
    PKT_SPM_SamplingProfilerUpdate = 0xD0,
    ...
    PKT_S2C_AntiBot = 0xE6,
    PKT_S2C_AntiBotWriteLog = 0xE7,
    PKT_S2C_AntiBotKickOut = 0xE8,
    PKT_S2C_AntiBotBanPlayer = 0xE9,
    PKT_S2C_AntiBotTrojan = 0xEA,
    PKT_S2C_AntiBotCloseClient = 0xEB,
    PKT_C2S_AntiBotDP = 0xEC,
    PKT_C2S_AntiBot = 0xED,
