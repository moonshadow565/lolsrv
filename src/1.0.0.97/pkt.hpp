...
enum pkttype_e
{
    ...
    PKT_S2C_SetCircularCameraRestriction = 0x87,
    PKT_S2C_LockCamera = 0x88,
    PKT_OnReplication = 0x89,
    PKT_OnReplication_Acc = 0x8A,
    PKT_S2C_MoveCameraToPoint = 0x8B,
    PKT_S2C_PlayTutorialAudioEvent = 0x8C,
    PKT_ChangeSlotSpellType = 0x8D,
    PKT_PausePacket = 0x8E,
    PKT_ResumePacket = 0x8F,
    PKT_SetFrequency = 0x90,
    PKT_SetFadeOut_Push = 0x91,
    PKT_SetFadeOut_Pop = 0x92,
    PKT_S2C_CreateUnitHighlight = 0x93,
    PKT_S2C_RemoveUnitHighlight = 0x94,
    PKT_S2C_OpenTutorialPopup = 0x95,
    PKT_C2S_OnTutorialPopupClosed = 0x96,
    PKT_S2C_OpenAFKWarningMessage = 0x97,
    PKT_S2C_CloseShop = 0x98,
    PKT_S2C_SetInputLockingFlag = 0x99,
    PKT_C2S_OnShopOpened = 0x9A,
    PKT_S2C_ShowObjectiveText = 0x9B,
    PKT_S2C_HideObjectiveText = 0x9C,
    PKT_S2C_RefreshObjectiveText = 0x9D,
    PKT_S2C_ShowAuxiliaryText = 0x9E,
    PKT_S2C_HideAuxiliaryText = 0x9F,
    PKT_S2C_RefreshAuxiliaryText = 0xA0,
    PKT_S2C_HighlightHUDElement = 0xA1,
    PKT_S2C_HighlightShopElement = 0xA2,
    PKT_C2S_TeamSurrenderVote = 0xA3,
    PKT_S2C_TeamSurrenderVote = 0xA4,
    PKT_S2C_TeamSurrenderCountDown = 0xA5,
    PKT_S2C_TeamSurrenderStatus = 0xA6,
    PKT_S2C_LineMissileHitList = 0xA7,
    PKT_C2S_TutorialAudioEventFinished = 0xA8,
    PKT_S2C_HighlightTitanBarElement = 0xA9,
    PKT_S2C_ToggleUIHighlight = 0xAA,
    PKT_S2C_DisplayLocalizedTutorialChatText = 0xAB,
    PKT_S2C_ToolTipVars = 0xAC,
    PKT_S2C_MuteVolumeCategory = 0xAD,
    PKT_S2C_OnEventWorld = 0xAE,
    PKT_S2C_AnimatedBuildingSetCurrentSkin = 0xAF,
    PKT_S2C_SetGreyscaleEnabledWhenDead = 0xB0,
    PKT_S2C_DisableHUDForEndOfGame = 0xB1,
    PKT_ChangeSlotSpellName = 0xB2,
    PKT_S2C_SwitchNexusesToOnIdleParticles = 0xB3,
    PKT_S2C_FadeMinions = 0xB4,
    PKT_S2C_FadeOutMainSFX = 0xB5,
    PKT_S2C_HeroStats = 0xB6,
    PKT_S2C_SetAnimStates = 0xB7,
    PKT_ClientCheatDetectionSignal = 0xB8,
    PKT_S2C_AddDebugCircle = 0xB9,
    PKT_S2C_RemoveDebugCircle = 0xBA,
    PKT_S2C_ModifyDebugCircleRadius = 0xBB,
    PKT_S2C_ModifyDebugCircleColor = 0xBC,
    PKT_Undefined = 0xBD,
    PKT_S2C_Neutral_Camp_Empty = 0xBE,
    PKT_Batched = 0xFF,
};
