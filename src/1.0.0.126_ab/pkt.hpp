...
enum pkttype_e
{
    ...
    PKT_ClientDetectionSignal = 0x81,
    ...
    PKT_S2C_Exit = 0xA0,
    PKT_SPM_RemoveBBProfileListener = 0xA1,
    ...
    PKT_ReloadScripts = 0xB5,
    PKT_Cheat = 0xB6,
    PKT_OnEnterLocalVisiblityClient = 0xB7,
    PKT_S2C_HighlightShopElement = 0xB8,
    PKT_SendSelectedObjID = 0xB9,
    PKT_S2C_PlayAnimation = 0xBA,
    PKT_S2C_RefreshAuxiliaryText = 0xBB,
    PKT_SetFadeOut_Push = 0xBC,
    PKT_S2C_OpenTutorialPopup = 0xBD,
    PKT_S2C_RemoveUnitHighlight = 0xBE,
    PKT_NPC_CastSpellAns = 0xBF,
    PKT_SPM_HierarchicalBBProfileUpdate = 0xC0,
    PKT_NPC_BuffAdd2 = 0xC1,
    PKT_S2C_OpenAFKWarningMessage = 0xC2,
    PKT_WaypointList = 0xC3,
    PKT_OnEnterVisiblityClient = 0xC4,
    PKT_S2C_AddDebugCircle = 0xC5,
    PKT_S2C_DisableHUDForEndOfGame = 0xC6,
    PKT_SynchVersionC2S = 0xC7,
    PKT_C2S_CharSelected = 0xC8,
    PKT_NPC_BuffUpdateCountGroup = 0xC9,
    PKT_AI_TargetHeroS2C = 0xCA,
    PKT_SynchSimTimeS2C = 0xCB,
    PKT_SyncMissionStartTimeS2C = 0xCC,
    PKT_S2C_Neutral_Camp_Empty = 0xCD,
    PKT_OnReplication = 0xCE,
    PKT_S2C_EndOfGameEvent = 0xCF,
    PKT_S2C_EndGame = 0xD0,
    PKT_Undefined = 0xD1,
    PKT_SPM_SamplingProfilerUpdate = 0xD2,
    PKT_S2C_PopAllCharacterData = 0xD3,
    PKT_S2C_TeamSurrenderVote = 0xD4,
    PKT_S2C_HandleUIHighlight = 0xD5,
    PKT_S2C_FadeMinions = 0xD6,
    PKT_C2S_OnTutorialPopupClosed = 0xD7,
    PKT_C2S_OnQuestEvent = 0xD8,
    PKT_S2C_ShowHealthBar = 0xD9,
    PKT_SpawnBotS2C = 0xDA,
    PKT_SpawnLevelPropS2C = 0xDB,
    PKT_UpdateLevelPropS2C = 0xDC,
    PKT_AttachFlexParticleS2C = 0xDD,
    PKT_S2C_HandleCapturePointUpdate = 0xDE,
    PKT_S2C_HandleGameScore = 0xDF,
    PKT_S2C_HandleRespawnPointUpdate = 0xE0,
    PKT_C2S_OnRespawnPointEvent = 0xE1,
    PKT_S2C_UnitChangeTeam = 0xE2,
    PKT_S2C_UnitSetMinimapIcon = 0xE3,
    PKT_S2C_IncrementPlayerScore = 0xE4,
    PKT_S2C_IncrementPlayerStat = 0xE5,
    PKT_S2C_ColorRemapFX = 0xE6,
    PKT_S2C_MusicCueCommand = 0xE7,
    PKT_S2C_AntiBot = 0xE8,
    PKT_S2C_AntiBotWriteLog = 0xE9,
    PKT_S2C_AntiBotKickOut = 0xEA,
    PKT_S2C_AntiBotBanPlayer = 0xEB,
    PKT_S2C_AntiBotTrojan = 0xEC,
    PKT_S2C_AntiBotCloseClient = 0xED,
    PKT_C2S_AntiBotDP = 0xEE,
    PKT_C2S_AntiBot = 0xEF,
    PKT_S2C_OnEnterTeamVisiblity = 0xF0,
    PKT_S2C_OnLeaveTeamVisiblity = 0xF1,
    PKT_S2C_FX_OnEnterTeamVisiblity = 0xF2,
    PKT_S2C_FX_OnLeaveTeamVisiblity = 0xF3,
    PKT_ReplayOnly_GoldEarned = 0xF4,
