...
using ProtoVer = PROTO_VER(1.0.0.126);

std::string_view ProtoVer::name() const { return "1.0.0.126"; }
...
void ProtoVer::read(Data_in& io, PKT_RemoveItemReq& value) const {
    ...
    io.bit<uint8_t>(field<uint8_t, 7>(value.slot), field<uint8_t, 1>(value.bSell));
}
