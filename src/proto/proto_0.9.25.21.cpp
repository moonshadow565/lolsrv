...
Span<ProtoNameID const> ProtoVer::pkt_array() const {
    static ProtoNameID const info[] = {
        ...
        {"PKT_S2C_SetInputLockingFlag", 0x95},
        // 0x96 ??
        {"PKT_S2C_ShowObjectiveText", 0x97},
        {"PKT_S2C_HideObjectiveText", 0x98},
        {"PKT_S2C_RefreshObjectiveText", 0x99},
        {"PKT_S2C_ShowAuxiliaryText", 0x9A},
        {"PKT_S2C_HideAuxiliaryText", 0x9B},
        {"PKT_S2C_RefreshAuxiliaryText", 0x9C},
        {"PKT_S2C_HighlightHUDElement", 0x9C},
        {"PKT_S2C_HighlightShopElement", 0x9D},
        {"PKT_C2S_TeamSurrenderVote", 0x9E},
        {"PKT_S2C_TeamSurrenderVote", 0xA0},
        {"PKT_S2C_TeamSurrenderCountDown", 0xA1},
        {"PKT_S2C_TeamSurrenderStatus", 0xA2},
        {"PKT_S2C_LineMissileHitList", 0xA3},
        {"PKT_C2S_TutorialAudioEventFinished", 0xA4},
        {"PKT_S2C_HighlightTitanBarElement", 0xA5},
        {"PKT_S2C_ToggleUIHighlight", 0xA6},
        {"PKT_S2C_DisplayLocalizedTutorialChatText", 0xA7},
        {"PKT_S2C_ToolTipVars", 0xA8},
        {"PKT_S2C_MuteVolumeCategory", 0xA9},
