...
void ProtoVer::read(Data_in& in, EGP_Chat& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, EGP_Chat const& value) const WRITE_NOT_IMPL

void ProtoVer::read(Data_in& in, CommonBasicAttack& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, CommonBasicAttack const& value) const WRITE_NOT_IMPL
...
void ProtoVer::read(Data_in& in, PKT_Basic_Attack& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, PKT_Basic_Attack const& value) const WRITE_NOT_IMPL

void ProtoVer::read(Data_in& in, PKT_Basic_Attack_Pos& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, PKT_Basic_Attack_Pos const& value) const WRITE_NOT_IMPL

void ProtoVer::read(Data_in& in, PKT_BuyItemAns& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, PKT_BuyItemAns const& value) const WRITE_NOT_IMPL

void ProtoVer::read(Data_in& in, PKT_BuyItemReq& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, PKT_BuyItemReq const& value) const WRITE_NOT_IMPL
...
void ProtoVer::read(Data_in& in, PKT_C2S_MapPing& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, PKT_C2S_MapPing const& value) const WRITE_NOT_IMPL
...
void ProtoVer::read(Data_in& in, PKT_C2S_PlayEmote& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, PKT_C2S_PlayEmote const& value) const WRITE_NOT_IMPL
...
void ProtoVer::read(Data_in& in, PKT_NPC_Die& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, PKT_NPC_Die const& value) const WRITE_NOT_IMPL

void ProtoVer::read(Data_in& in, PKT_NPC_LevelUp& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, PKT_NPC_LevelUp const& value) const WRITE_NOT_IMPL
...
void ProtoVer::read(Data_in& in, PKT_NPC_UpgradeSpellAns& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, PKT_NPC_UpgradeSpellAns const& value) const WRITE_NOT_IMPL

void ProtoVer::read(Data_in& in, PKT_NPC_UpgradeSpellReq& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, PKT_NPC_UpgradeSpellReq const& value) const WRITE_NOT_IMPL
...
void ProtoVer::read(Data_in& in, PKT_RemoveItemAns& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, PKT_RemoveItemAns const& value) const WRITE_NOT_IMPL

void ProtoVer::read(Data_in& in, PKT_RemoveItemReq& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, PKT_RemoveItemReq const& value) const WRITE_NOT_IMPL
...
void ProtoVer::read(Data_in& in, PKT_S2C_ChangeCharacterData& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, PKT_S2C_ChangeCharacterData const& value) const WRITE_NOT_IMPL
...
void ProtoVer::read(Data_in& in, PKT_S2C_MapPing& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, PKT_S2C_MapPing const& value) const WRITE_NOT_IMPL
...
void ProtoVer::read(Data_in& in, PKT_S2C_PlayAnimation& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, PKT_S2C_PlayAnimation const& value) const WRITE_NOT_IMPL

void ProtoVer::read(Data_in& in, PKT_S2C_PlayEmote& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, PKT_S2C_PlayEmote const& value) const WRITE_NOT_IMPL
...
void ProtoVer::read(Data_in& in, PKT_SwapItemAns& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, PKT_SwapItemAns const& value) const WRITE_NOT_IMPL

void ProtoVer::read(Data_in& in, PKT_SwapItemReq& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, PKT_SwapItemReq const& value) const WRITE_NOT_IMPL

void ProtoVer::read(Data_in& in, PKT_S2C_ToggleFoW& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, PKT_S2C_ToggleFoW const& value) const WRITE_NOT_IMPL
...
void ProtoVer::read(Data_in& in, PKT_World_LockCamera_Server& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, PKT_World_LockCamera_Server const& value) const WRITE_NOT_IMPL

void ProtoVer::read(Data_in& in, PKT_World_SendCamera_Server& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, PKT_World_SendCamera_Server const& value) const WRITE_NOT_IMPL

void ProtoVer::read(Data_in& in, PKT_World_SendCamera_Server_Acknologment& value) const READ_NOT_IMPL
void ProtoVer::write(Data_out& out, PKT_World_SendCamera_Server_Acknologment const& value) const WRITE_NOT_IMPL
