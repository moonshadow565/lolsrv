...
using ProtoVer = PROTO_VER(1.0.0.104);

std::string_view ProtoVer::name() const { return "1.0.0.104"; }
...
void ProtoVer::read(Data_in& io, PKT_S2C_MapPing& value) const {
    ...
    io.bit<uint8_t>(field<uint8_t, 1>(value.bPlayAudio), field<uint8_t, 1>(value.bShowChat));
}
