...
enum pkttype_e
{
    ...
    PKT_SPM_HierarchicalProfilerUpdate = 0x47,
    PKT_SPM_HierarchicalMemoryUpdate = 0x48,
    PKT_SPM_HierarchicalBBProfileUpdate = 0x49,
    PKT_SPM_SamplingProfilerUpdate = 0x4A,
    PKT_SPM_AddBBProfileListener = 0x4B,
    PKT_SPM_RemoveBBProfileListener = 0x4C,
    PKT_HeroReincarnateAlive = 0x4D,
    PKT_HeroReincarnate = 0x4E,
    PKT_Building_Die = 0x4F,
    PKT_SynchSimTimeS2C = 0x50,
    PKT_SynchSimTimeC2S = 0x51,
    PKT_SyncSimTimeFinalS2C = 0x52,
    PKT_WaypointList = 0x53,
    PKT_WaypointListHeroWithSpeed = 0x54,
    PKT_ServerGameSettings = 0x55,
    PKT_NPC_BuffUpdateCount = 0x56,
    PKT_C2S_PlayEmoticon = 0x57,
    PKT_S2C_PlayEmoticon = 0x58,
    PKT_AvatarInfo_Server = 0x59,
    PKT_RemovePerceptionBubble = 0x5A,
    PKT_AddUnitPerceptionBubble = 0x5B,
    PKT_AddPosPerceptionBubble = 0x5C,
    PKT_SpawnMinionS2C = 0x5D,
    PKT_S2C_StopAnimation = 0x5E,
    PKT_UpdateGoldRedirectTarget = 0x5F,
    PKT_S2C_ChangeCharacterData = 0x60,
    PKT_S2C_PopCharacterData = 0x61,
    PKT_S2C_PopAllCharacterData = 0x62,
    PKT_S2C_FaceDirection = 0x63,
    PKT_S2C_CameraBehavior = 0x64,
    PKT_SPM_AddListener = 0x65,
    PKT_SPM_RemoveListener = 0x66,
    ...
    PKT_S2C_BotAI = 0x6C,
    PKT_S2C_AI_TargetSelection = 0x6D,
    PKT_S2C_AI_State = 0x6E,
    PKT_OnEvent = 0x6F,
    PKT_OnDisconnected = 0x70,
    PKT_World_SendCamera_Server_Acknologment = 0x71,
    PKT_World_SendGameNumber = 0x72,
    PKT_NPC_Die_EventHistroy = 0x73,
    PKT_C2S_Ping_Load_Info = 0x74,
    PKT_S2C_Ping_Load_Info = 0x75,
    PKT_C2S_Exit = 0x76,
    PKT_S2C_Exit = 0x77,
    PKT_C2S_Reconnect = 0x78,
    PKT_S2C_Reconnect = 0x79,
    PKT_S2C_Reconnect_Done = 0x7A,
    PKT_Waypoint_Acc = 0x7B,
    PKT_WaypointGroup = 0x7C,
    PKT_WaypointGroupWithSpeed = 0x7D,
    PKT_Connected = 0x7E,
    PKT_S2C_ToggleInputLockingFlag = 0x7F,
    PKT_S2C_ToggleFoW = 0x80,
    PKT_S2C_SetCircularCameraRestriction = 0x81,
    PKT_S2C_LockCamera = 0x82,
    PKT_OnReplication = 0x83,
    PKT_OnReplication_Acc = 0x84,
    PKT_S2C_MoveCameraToPoint = 0x85,
    PKT_S2C_PlayTutorialAudioEvent = 0x86,
    PKT_ChangeSlotSpellType = 0x87,
    PKT_PausePacket = 0x88,
    PKT_ResumePacket = 0x89,
    PKT_SetFrequency = 0x8A,
    PKT_SetFadeOut_Push = 0x8B,
    PKT_SetFadeOut_Pop = 0x8C,
    ...
    PKT_ClientCheatDetectionSignal = 0xB2,
