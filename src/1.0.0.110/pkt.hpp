...
enum pkttype_e
{
    ...
    PKT_S2C_PopCharacterData = 0x64,
    PKT_NPC_BuffAddGroup = 0x65,
    PKT_S2C_AI_TargetSelection = 0x66,
    PKT_AI_TargetS2C = 0x67,
    PKT_S2C_SetAnimStates = 0x68,
    PKT_S2C_ChainMissileSync = 0x69,
    PKT_C2S_OnTipEvent = 0x6A,
    PKT_MissileReplication_ChainMissile = 0x6B,
    PKT_BuyItemAns = 0x6C,
    PKT_NPC_IssueOrderReq = 0x6E,
    PKT_S2C_CameraBehavior = 0x6F,
    PKT_S2C_AnimatedBuildingSetCurrentSkin = 0x70,
    PKT_Connected = 0x71,
    PKT_SyncSimTimeFinalS2C = 0x72,
    PKT_Waypoint_Acc = 0x73,
    PKT_AddPosPerceptionBubble = 0x74,
    PKT_S2C_LockCamera = 0x75,
    PKT_S2C_PlayVOAudioEvent = 0x76,
    PKT_AI_Command = 0x77,
    PKT_NPC_BuffRemove2 = 0x78,
    PKT_SpawnMinionS2C = 0x79,
    PKT_ClientCheatDetectionSignal = 0x7A,
    PKT_S2C_ToggleFoW = 0x7B,
    PKT_S2C_ToolTipVars = 0x7C,
    PKT_UnitApplyHeal = 0x7D,
    PKT_GlobalCombatMessage = 0x7E,
    PKT_World_LockCamera_Server = 0x7F,
    PKT_SetItem = 0x80,
    PKT_BuyItemReq = 0x80,
    PKT_WaypointListHeroWithSpeed = 0x81,
    PKT_S2C_SetInputLockingFlag = 0x82,
    PKT_CHAR_SetCooldown = 0x83,
    PKT_FX_Create_Group = 0x84,
    PKT_S2C_QueryStatusAns = 0x85,
    PKT_Building_Die = 0x86,
    PKT_SPM_RemoveListener = 0x87,
    PKT_S2C_HandleQuestUpdate = 0x88,
    PKT_C2S_ClientFinished = 0x89,
    PKT_CHAT = 0x8A,
    PKT_SPM_RemoveMemoryListener = 0x8B,
    PKT_C2S_Exit = 0x8C,
    PKT_ServerGameSettings = 0x8D,
    PKT_S2C_ModifyDebugCircleColor = 0x8E,
    PKT_SPM_AddListener = 0x8F,
    PKT_World_SendGameNumber = 0x90,
    PKT_C2S_ClientConnect_NamedPipe = 0x92,
    PKT_NPC_BuffRemoveGroup = 0x93,
    PKT_Turret_Fire = 0x94,
    PKT_S2C_Ping_Load_Info = 0x95,
    PKT_S2C_ChangeCharacterData = 0x96,
    PKT_S2C_Exit = 0x97,
    PKT_SPM_RemoveBBProfileListener = 0x98,
    PKT_NPC_CastSpellReq = 0x99,
    PKT_S2C_ToggleInputLockingFlag = 0x9A,
    PKT_C2S_Reconnect = 0x9B,
    PKT_S2C_CreateTurret = 0x9C,
    PKT_NPC_Die = 0x9D,
    PKT_UseItemAns = 0x9E,
    PKT_S2C_ShowAuxiliaryText = 0x9F,
    PKT_PausePacket = 0xA0,
    PKT_S2C_HideObjectiveText = 0xA1,
    PKT_OnEvent = 0xA2,
    PKT_C2S_TeamSurrenderVote = 0xA3,
    PKT_S2C_TeamSurrenderStatus = 0xA4,
    PKT_SPM_AddBBProfileListener = 0xA5,
    PKT_S2C_HideAuxiliaryText = 0xA6,
    PKT_OnReplication_Acc = 0xA7,
    PKT_OnDisconnected = 0xA8,
    PKT_S2C_SetGreyscaleEnabledWhenDead = 0xA9,
    PKT_S2C_AI_State = 0xAA,
    PKT_S2C_SetFoWStatus = 0xAB,
    PKT_OnEnterLocalVisiblityClient = 0xAC,
    PKT_S2C_HighlightShopElement = 0xAD,
    PKT_SendSelectedObjID = 0xAE,
    PKT_S2C_PlayAnimation = 0xAF,
    PKT_S2C_RefreshAuxiliaryText = 0xB0,
    PKT_SetFadeOut_Push = 0xB1,
    PKT_S2C_OpenTutorialPopup = 0xB2,
    PKT_S2C_RemoveUnitHighlight = 0xB3,
    PKT_NPC_CastSpellAns = 0xB4,
    PKT_SPM_HierarchicalBBProfileUpdate = 0xB5,
    PKT_NPC_BuffAdd2 = 0xB6,
    PKT_S2C_OpenAFKWarningMessage = 0xB7,
    PKT_WaypointList = 0xB8,
    PKT_OnEnterVisiblityClient = 0xB9,
    PKT_S2C_AddDebugCircle = 0xBA,
    PKT_S2C_DisableHUDForEndOfGame = 0xBB,
    PKT_SynchVersionC2S = 0xBC,
    PKT_C2S_CharSelected = 0xBD,
    PKT_NPC_BuffUpdateCountGroup = 0xBE,
    PKT_AI_TargetHeroS2C = 0xBF,
    PKT_SynchSimTimeS2C = 0xC0,
    PKT_S2C_Neutral_Camp_Empty = 0xC1,
    PKT_OnReplication = 0xC2,
    PKT_S2C_EndGame = 0xC3,
    PKT_Undefined = 0xC4,
    PKT_SPM_SamplingProfilerUpdate = 0xC5,
    PKT_S2C_PopAllCharacterData = 0xC6,
    PKT_S2C_TeamSurrenderVote = 0xC7,
    PKT_S2C_HandleUIHighlight = 0xC8,
    PKT_S2C_FadeMinions = 0xC9,
    PKT_C2S_OnTutorialPopupClosed = 0xCA,
    PKT_C2S_OnQuestEvent = 0xCB,
    PKT_S2C_ShowHealthBar = 0xCC,
    PKT_SpawnLevelPropS2C = 0xCE,
    PKT_UpdateLevelPropS2C = 0xCF,
    PKT_S2C_HandleCapturePointUpdate = 0xD0,
    PKT_S2C_HandleGameScore = 0xD1,
    PKT_S2C_HandleRespawnPointUpdate = 0xD2,
    PKT_C2S_OnRespawnPointEvent = 0xD3,
    PKT_S2C_UnitChangeTeam = 0xD4,
    PKT_S2C_UnitSetMinimapIcon = 0xD5,
    PKT_Batched = 0xFF,
};
