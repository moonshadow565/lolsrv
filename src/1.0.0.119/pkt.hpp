...
enum pkttype_e
{
    ...
    PKT_RemovePerceptionBubble = 0x37,
    PKT_NPC_InstantStop_Attack = 0x38,
    PKT_OnLeaveLocalVisiblityClient = 0x39,
    PKT_S2C_ShowObjectiveText = 0x3A,
    PKT_CHAR_SpawnPet = 0x3B,
    PKT_FX_Kill = 0x3C,
    PKT_NPC_UpgradeSpellReq = 0x3D,
    PKT_Turret_CreateTurret = 0x3E,
    PKT_MissileReplication = 0x3F,
    PKT_S2C_HighlightHUDElement = 0x41,
    PKT_SwapItemAns = 0x42,
    PKT_NPC_LevelUp = 0x43,
    PKT_S2C_MapPing = 0x44,
    PKT_S2C_PlayEmote = 0x46,
    PKT_S2C_Reconnect_Done = 0x47,
    PKT_S2C_OnEventWorld = 0x48,
    PKT_S2C_HeroStats = 0x49,
    PKT_C2S_PlayEmote = 0x4A,
    PKT_HeroReincarnate = 0x4B,
    PKT_S2C_CreateHero = 0x4D,
    PKT_SPM_AddMemoryListener = 0x4E,
    PKT_SPM_HierarchicalMemoryUpdate = 0x4F,
    PKT_S2C_ToggleUIHighlight = 0x50,
    PKT_S2C_FaceDirection = 0x51,
    PKT_OnLeaveVisiblityClient = 0x52,
    PKT_C2S_ClientReady = 0x53,
    PKT_SynchVersionS2C = 0x55,
    PKT_S2C_HandleTipUpdate = 0x56,
    PKT_C2S_MapPing = 0x57,
    PKT_S2C_RemoveDebugCircle = 0x58,
    ...
    PKT_MissileReplication_ChainMissile = 0x6E,
    PKT_BuyItemAns = 0x6F,
    PKT_NPC_IssueOrderReq = 0x71,
    PKT_S2C_CameraBehavior = 0x72,
    PKT_S2C_AnimatedBuildingSetCurrentSkin = 0x73,
    PKT_Connected = 0x74,
    PKT_SyncSimTimeFinalS2C = 0x75,
    PKT_Waypoint_Acc = 0x76,
    PKT_AddPosPerceptionBubble = 0x77,
    ...
    PKT_UnitApplyHeal = 0x80,
    PKT_GlobalCombatMessage = 0x81,
    PKT_World_LockCamera_Server = 0x82,
    PKT_SetItem = 0x83,
    PKT_BuyItemReq = 0x83,
    PKT_WaypointListHeroWithSpeed = 0x84,
    PKT_S2C_SetInputLockingFlag = 0x85,
    PKT_CHAR_SetCooldown = 0x86,
    PKT_FX_Create_Group = 0x87,
    PKT_S2C_QueryStatusAns = 0x88,
    PKT_Building_Die = 0x89,
    PKT_SPM_RemoveListener = 0x8A,
    PKT_S2C_HandleQuestUpdate = 0x8B,
    PKT_C2S_ClientFinished = 0x8C,
    PKT_CHAT = 0x8D,
    PKT_SPM_RemoveMemoryListener = 0x8E,
    PKT_C2S_Exit = 0x8F,
    PKT_ServerGameSettings = 0x90,
    PKT_S2C_ModifyDebugCircleColor = 0x91,
    PKT_SPM_AddListener = 0x92,
    PKT_World_SendGameNumber = 0x93,
    PKT_C2S_ClientConnect_NamedPipe = 0x95,
    PKT_NPC_BuffRemoveGroup = 0x96,
    PKT_Turret_Fire = 0x97,
    PKT_S2C_Ping_Load_Info = 0x98,
    PKT_S2C_ChangeCharacterData = 0x99,
    PKT_S2C_Exit = 0x9A,
    PKT_SPM_RemoveBBProfileListener = 0x9B,
    PKT_NPC_CastSpellReq = 0x9C,
    PKT_S2C_ToggleInputLockingFlag = 0x9D,
    PKT_C2S_Reconnect = 0x9E,
    PKT_S2C_CreateTurret = 0x9F,
    PKT_NPC_Die = 0xA0,
    PKT_UseItemAns = 0xA1,
    PKT_S2C_ShowAuxiliaryText = 0xA2,
    PKT_PausePacket = 0xA3,
    PKT_S2C_HideObjectiveText = 0xA4,
    PKT_OnEvent = 0xA5,
    PKT_C2S_TeamSurrenderVote = 0xA6,
    PKT_S2C_TeamSurrenderStatus = 0xA7,
    PKT_SPM_AddBBProfileListener = 0xA8,
    PKT_S2C_HideAuxiliaryText = 0xA9,
    PKT_OnReplication_Acc = 0xAA,
    PKT_OnDisconnected = 0xAB,
    PKT_S2C_SetGreyscaleEnabledWhenDead = 0xAC,
    PKT_S2C_AI_State = 0xAD,
    PKT_S2C_SetFoWStatus = 0xAE,
    PKT_OnEnterLocalVisiblityClient = 0xAF,
    PKT_S2C_HighlightShopElement = 0xB0,
    PKT_SendSelectedObjID = 0xB1,
    PKT_S2C_PlayAnimation = 0xB2,
    PKT_S2C_RefreshAuxiliaryText = 0xB3,
    PKT_SetFadeOut_Push = 0xB4,
    PKT_S2C_OpenTutorialPopup = 0xB5,
    PKT_S2C_RemoveUnitHighlight = 0xB6,
    PKT_NPC_CastSpellAns = 0xB7,
    PKT_SPM_HierarchicalBBProfileUpdate = 0xB8,
    PKT_NPC_BuffAdd2 = 0xB9,
    PKT_S2C_OpenAFKWarningMessage = 0xBA,
    PKT_WaypointList = 0xBB,
    PKT_OnEnterVisiblityClient = 0xBC,
    PKT_S2C_AddDebugCircle = 0xBD,
    PKT_S2C_DisableHUDForEndOfGame = 0xBE,
    PKT_SynchVersionC2S = 0xBF,
    PKT_C2S_CharSelected = 0xC0,
    PKT_NPC_BuffUpdateCountGroup = 0xC1,
    PKT_AI_TargetHeroS2C = 0xC2,
    PKT_SynchSimTimeS2C = 0xC3,
    PKT_S2C_Neutral_Camp_Empty = 0xC4,
    PKT_OnReplication = 0xC5,
    PKT_S2C_EndGame = 0xC6,
    PKT_Undefined = 0xC7,
    PKT_SPM_SamplingProfilerUpdate = 0xC8,
    PKT_S2C_PopAllCharacterData = 0xC9,
    PKT_S2C_TeamSurrenderVote = 0xCA,
    PKT_S2C_HandleUIHighlight = 0xCB,
    PKT_S2C_FadeMinions = 0xCC,
    PKT_C2S_OnTutorialPopupClosed = 0xCD,
    PKT_C2S_OnQuestEvent = 0xCE,
    PKT_S2C_ShowHealthBar = 0xCF,
    PKT_SpawnLevelPropS2C = 0xD1,
    PKT_UpdateLevelPropS2C = 0xD2,
