...
enum pkttype_e
{
    ...
    PKT_SPM_HierarchicalProfilerUpdate = 0x4E,
    PKT_SPM_HierarchicalMemoryUpdate = 0x4F,
    PKT_SPM_HierarchicalBBProfileUpdate = 0x50,
    PKT_SPM_SamplingProfilerUpdate = 0x51,
    PKT_SPM_AddBBProfileListener = 0x52,
    PKT_SPM_RemoveBBProfileListener = 0x53,
    PKT_HeroReincarnateAlive = 0x54,
    PKT_HeroReincarnate = 0x55,
    PKT_Building_Die = 0x56,
    PKT_SynchSimTimeS2C = 0x57,
    PKT_SynchSimTimeC2S = 0x58,
    PKT_SyncSimTimeFinalS2C = 0x59,
    PKT_WaypointList = 0x5A,
    PKT_WaypointListHeroWithSpeed = 0x5B,
    PKT_ServerGameSettings = 0x5C,
    PKT_NPC_BuffUpdateCount = 0x5D,
    PKT_NPC_BuffUpdateCountGroup = 0x5E,
    PKT_C2S_PlayEmoticon = 0x5F,
    PKT_S2C_PlayEmoticon = 0x60,
    PKT_AvatarInfo_Server = 0x61,
    PKT_RemovePerceptionBubble = 0x62,
    PKT_AddUnitPerceptionBubble = 0x63,
    PKT_AddPosPerceptionBubble = 0x64,
    PKT_SpawnMinionS2C = 0x65,
    PKT_S2C_StopAnimation = 0x66,
    PKT_S2C_ShowHealthBar = 0x67,
    PKT_UpdateGoldRedirectTarget = 0x68,
    PKT_S2C_ChangeCharacterData = 0x69,
    PKT_S2C_PopCharacterData = 0x6A,
    PKT_S2C_PopAllCharacterData = 0x6B,
    PKT_S2C_FaceDirection = 0x6C,
    PKT_S2C_CameraBehavior = 0x6D,
    PKT_SPM_AddListener = 0x6E,
    PKT_SPM_RemoveListener = 0x6F,
    PKT_SPM_AddMemoryListener = 0x70,
    PKT_SPM_RemoveMemoryListener = 0x71,
    PKT_S2C_DestroyClientMissile = 0x72,
    PKT_S2C_ChainMissileSync = 0x73,
    PKT_MissileReplication_ChainMissile = 0x74,
    PKT_S2C_BotAI = 0x75,
    PKT_S2C_AI_TargetSelection = 0x76,
    PKT_S2C_AI_State = 0x77,
    PKT_OnEvent = 0x78,
    PKT_OnDisconnected = 0x79,
    PKT_World_SendCamera_Server_Acknologment = 0x7A,
    PKT_World_SendGameNumber = 0x7B,
    PKT_NPC_Die_EventHistroy = 0x7C,
    PKT_C2S_Ping_Load_Info = 0x7D,
    PKT_S2C_Ping_Load_Info = 0x7E,
    PKT_C2S_Exit = 0x7F,
    PKT_S2C_Exit = 0x80,
    PKT_C2S_Reconnect = 0x81,
    PKT_S2C_Reconnect = 0x82,
    PKT_S2C_Reconnect_Done = 0x83,
    PKT_Waypoint_Acc = 0x84,
    PKT_WaypointGroup = 0x85,
    PKT_WaypointGroupWithSpeed = 0x86,
    PKT_Connected = 0x87,
    PKT_S2C_ToggleInputLockingFlag = 0x88,
    PKT_S2C_ToggleFoW = 0x89,
    PKT_S2C_SetFoWStatus = 0x8A,
    PKT_S2C_SetCircularCameraRestriction = 0x8B,
    PKT_S2C_LockCamera = 0x8C,
    PKT_OnReplication = 0x8D,
    PKT_OnReplication_Acc = 0x8E,
    PKT_S2C_MoveCameraToPoint = 0x8F,
    PKT_S2C_HandleQuestUpdate = 0x90,
    PKT_C2S_OnQuestEvent = 0x91,
    PKT_S2C_HandleTipUpdate = 0x92,
    PKT_S2C_HandleUIHighlight = 0x93,
    PKT_C2S_OnTipEvent = 0x94,
    PKT_S2C_PlayVOAudioEvent = 0x95,
    PKT_ChangeSlotSpellType = 0x96,
    PKT_PausePacket = 0x97,
    PKT_ResumePacket = 0x98,
    PKT_SetFrequency = 0x99,
    PKT_SetFadeOut_Push = 0x9A,
    PKT_SetFadeOut_Pop = 0x9B,
    PKT_S2C_CreateUnitHighlight = 0x9C,
    PKT_S2C_RemoveUnitHighlight = 0x9D,
    PKT_S2C_OpenTutorialPopup = 0x9E,
    PKT_C2S_OnTutorialPopupClosed = 0x9F,
    PKT_S2C_OpenAFKWarningMessage = 0xA0,
    PKT_S2C_CloseShop = 0xA1,
    PKT_S2C_SetInputLockingFlag = 0xA2,
    PKT_C2S_OnShopOpened = 0xA3,
    PKT_S2C_ShowObjectiveText = 0xA5,
    PKT_S2C_HideObjectiveText = 0xA6,
    PKT_S2C_RefreshObjectiveText = 0xA7,
    PKT_S2C_ShowAuxiliaryText = 0xA8,
    PKT_S2C_HideAuxiliaryText = 0xA9,
    PKT_S2C_RefreshAuxiliaryText = 0xAA,
    PKT_S2C_HighlightHUDElement = 0xAB,
    PKT_S2C_HighlightShopElement = 0xAC,
    PKT_C2S_TeamSurrenderVote = 0xAD,
    PKT_S2C_TeamSurrenderVote = 0xAE,
    PKT_S2C_TeamSurrenderCountDown = 0xAF,
    PKT_S2C_TeamSurrenderStatus = 0xB0,
    PKT_S2C_LineMissileHitList = 0xB1,
    PKT_C2S_TutorialAudioEventFinished = 0xB2,
    PKT_S2C_HighlightTitanBarElement = 0xB3,
    PKT_S2C_ToggleUIHighlight = 0xB4,
    PKT_S2C_DisplayLocalizedTutorialChatText = 0xB5,
    PKT_S2C_ToolTipVars = 0xB6,
    PKT_S2C_MuteVolumeCategory = 0xB7,
    PKT_S2C_OnEventWorld = 0xB8,
    PKT_S2C_AnimatedBuildingSetCurrentSkin = 0xB9,
    PKT_S2C_SetGreyscaleEnabledWhenDead = 0xBA,
    PKT_S2C_DisableHUDForEndOfGame = 0xBB,
    PKT_ChangeSlotSpellName = 0xBC,
    PKT_S2C_SwitchNexusesToOnIdleParticles = 0xBD,
    PKT_S2C_FadeMinions = 0xBE,
    PKT_S2C_FadeOutMainSFX = 0xBF,
    PKT_S2C_HeroStats = 0xC0,
    PKT_S2C_SetAnimStates = 0xC1,
    PKT_ClientCheatDetectionSignal = 0xC2,
    PKT_S2C_AddDebugCircle = 0xC3,
    PKT_S2C_RemoveDebugCircle = 0xC4,
    PKT_S2C_ModifyDebugCircleRadius = 0xC5,
    PKT_S2C_ModifyDebugCircleColor = 0xC6,
    PKT_Undefined = 0xC7,
    PKT_S2C_Neutral_Camp_Empty = 0xC8,
    PKT_Batched = 0xFF,
};
